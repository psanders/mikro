...
Started: 2026-07-04
Current stage: DONE — synced + archived. Only residual: 6.3 live-app drive (needs founder auth).
...
| 5   | Sync            | done   | Delta specs merged into main specs: new `openspec/specs/feedback-submission/spec.md`; `bug-report-desktop-capture` + `bug-report-mobile-capture` reframed (submitFeedback, message icon, wording) preserving their extra requirements. All 3 validate `--strict`. Pre-existing `no-referrals` spec failure is unrelated.                                                                                                                            |
| 6   | Archive         | done   | Moved to `openspec/changes/archive/2026-07-04-reframe-bug-report-as-feedback/`. Task 6.3 (drive live founder flow — needs auth) left unchecked.                                                                                                                                                                                                                                                                                                     |
