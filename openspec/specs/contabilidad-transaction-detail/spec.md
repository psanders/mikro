# contabilidad-transaction-detail Specification

## Purpose

The transaction detail screen (`/contabilidad/:id`) gives operators a full view of a single transaction's fields, attachments, and lifecycle actions (including reversal).
