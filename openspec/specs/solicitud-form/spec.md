# solicitud-form Specification

## Purpose

The public website loan application form (`/solicitud` stepper and `/solicitud-v0` legacy accordion): sections, fields, progress, and result screens.
