# founder-search Specification

## Purpose

Universal search for the founder app: one input across clients, loans, and feed events with grouped results and inline navigation.
