...
**Reason**: The mobile evaluator is retired; every step moves to the Ops app (see ops-application-flow).
**Migration**: Use the Ops app: feed cards and the application side panel.
