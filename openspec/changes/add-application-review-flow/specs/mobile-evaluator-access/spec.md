...
**Reason**: The mobile evaluator is retired; application review moves to the Ops app.
**Migration**: REVIEWER/ADMIN users review in the Ops app; the mobile app shows collector navigation to everyone.
