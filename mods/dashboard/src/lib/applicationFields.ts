 ...
 *
 * Editable field config for the Solicitud edit modal, grouped by the public
 * form's sections. Enumerated fields reuse the form's option values so the
 * deterministic score keeps matching. Keys are the English content keys stored
 * in LoanApplication.rawData.
 */
...
const TIPO_NEGOCIO: FieldOption[] = [
...
export const EDIT_SECTIONS: FieldSection[] = [
  {
    title: "Personal",
    fields: [
