 ...
 */
// Import from the constants subpath, not the @mikro/common barrel: the barrel
// re-exports server-only modules (config.js → fs) that crash the browser bundle.
import {
  DEFAULT_MIN_RATE,
  DEFAULT_MAX_RATE,
  DEFAULT_PAYMENT_ROUNDING_INCREMENT
} from "@mikro/common/utils/loanCalculatorConstants";
