...
> = {
  ...
  meta: {
    modelProps: "user" | "userRole" | "member" | "loan" | "message" | "attachment";
 ...
 */
export type EnumLoanStatusFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  "LoanStatus"
>;
 ...
 */
export type EnumAttachmentTypeFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  "AttachmentType"
>;
