...
export function performanceFixture() {
  return {
    metrics: {
      period: { startDate: "2026-07-01", endDate: "2026-07-31" },
      loansByStatus: {
        ACTIVE: { count: 96, principalDop: 928000 },
        COMPLETED: { count: 20, principalDop: 180000 },
        DEFAULTED: { count: 12, principalDop: 84200 },
        CANCELLED: { count: 0, principalDop: 0 }
      },
      loansBySize: {
        standard: { count: 84, principalDop: 420000 },
        larger: { count: 38, principalDop: 380000 },
        exception: { count: 6, principalDop: 96000 }
      },
      totalLoans: 128,
      totalPrincipalDop: 1240000,
      totalExpectedRevenueDop: 1450000,
      estimatedLossesPrincipalDop: 41200,
      estimatedRevenueLostDop: 48000,
      projectedCollectibleDop: 1350000,
      projectedNetPositionDop: 286400,
      totalCollectedDop: 742300,
      defaultRateByCountPct: 9.4,
      defaultRateByCapitalPct: 6.8,
      collectionRatePct: 92.3,
      onTimePaymentRatePct: 81.2,
      portfolioAtRiskPct: 6.8
    },
    narrative: {
      executiveSummary:
        "La cartera creció 8% en julio con la tasa de cobro estable en 92.3%. La mora se concentra en 12 préstamos (6.8% del capital) y no muestra señales de deterioro sistémico. La posición neta proyectada mejora respecto al mes anterior.",
      keyInsights: [
        "Tasa de cobro sostenida por encima del 90% por tercer mes.",
        "38 préstamos 'Mayor (10k)' aportan el 31% del capital.",
        "20 préstamos completamente pagados, listos para renovación."
      ],
      riskAreas: [
        "4 préstamos en default concentran RD$1,435 de mora.",
        "La categoría 'Excepción' tiene el ticket más alto y menor cobertura."
      ],
      recommendation:
        "Priorizar contacto con los 4 préstamos en default antes del cierre de mes; el resto de la mora es recuperable con seguimiento estándar."
    },
    generatedAt: new Date("2026-07-08T00:00:00Z")
  };
}
